...
function Update(props) {
  ...
  const fetchDistricts = (value) => {
    axios
      .post("https://server-curtain.onrender.com/get-dist", { dis_name: value })
      .then((res) => {
  ...
  const fetchClients = (value) => {
    axios
      .get("https://server-curtain.onrender.com/client-select")
      .then((res) => {
  ...
  const fetchLocations = (value) => {
    axios
      .get("https://server-curtain.onrender.com/location-select")
      .then((res) => {
  ...
  const fetchCities = (value) => {
    axios
      .post("https://server-curtain.onrender.com/get-cities", { name: value })
      .then((res) => {
  ...
  const handleSearch = () => {
    ...
    axios
      .post("https://server-curtain.onrender.com/devicecheck", {
        id: formdata.mac,
      })
      .then((res) => {
        if (res.data != "Ok") {
          ...
          setformdata({
            ...
            district: res.data["district-select"],
            city: res.data["city-select"],
            location: res.data["location-select"],
  ...
  const handleUpdate = (event) => {
    ...
    if (!client || !city || !district || !location) {
      ...
      axios
        .post("https://server-curtain.onrender.com/add-data", formdata)
        .then((res) => {})
        .catch((err) => {
    ...
    // axios
    //   .post("https://server-curtain.onrender.com/update-device", { mac, client, city, district, location })
    //   .then((res) => {
