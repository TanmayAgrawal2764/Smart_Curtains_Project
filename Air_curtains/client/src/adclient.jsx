    ...
    >
      <div id="header">
        ...
        <form id="contact-form" onSubmit={adcl}>
          ...
          />
          {changing==1?
          <i id="available" class="fas fa-check-circle text-success availability-icon" style={{display: "inline", color: "green",position: "absolute",right: "40px",top: "32%",
    transform: "translateY(-50%)"}}></i>
  :<i id="available" class="fas fa-times-circle text-danger availability-icon" style={{display: "inline", color: "green",position: "absolute",right: "40px",top: "32%",
  transform: "translateY(-50%)"}}></i>}
          <input
            name="password"
            type="text"
          ...
          />
          {checkpw==1?
          <i id="available" class="fas fa-check-circle text-success availability-icon" style={{display: "inline", color: "green",position: "absolute",right: "40px",top: "44%",
    transform: "translateY(-50%)"}}></i>
  :<i id="available" class="fas fa-times-circle text-danger availability-icon" style={{display: "inline", color: "green",position: "absolute",right: "40px",top: "44%",
  transform: "translateY(-50%)"}}></i>}
          {/* <h4>Query Type</h4> */}
          ...
          <input
            ...
            required
          />
          {message!=""?<p style={message=="Client Added Successfully"?{color:"green"}:{color:"red"}}>{message}</p>:""}
          <button type="submit" onClick={adcl}>Send Message</button>
        </form>
      </div>
    </div>
  )
